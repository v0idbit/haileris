...
- **No mutation sites:** If a derivation contains only structural lines (imports, docstrings, type annotations), no mutations are generated. This is correct behavior — there is no behavioral code to mutate.
