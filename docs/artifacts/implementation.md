...
The green-phase production code written by Realize. Written directly to the project's source directory. Updated by Settle when implementation-domain findings are fixed.
