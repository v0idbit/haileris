...
Written by Harvest. Read by Inscribe as supplementary context for spec writing. Ingested by Etch and Realize as supplementary context for dependency APIs and project conventions. Stable after Harvest; refreshed by `--reharvest` when project standards change.
